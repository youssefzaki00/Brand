...
function CheckOut() {
  ...
  return (
    <div className="container mx-auto px-4 sm:px-8 md:px-16 lg:px-16 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-9 mt-4 gap-8">
      <div className="bg-white dark:bg-zinc-800 rounded-lg shadow-sm col-span-1 sm:col-span-1 md:col-span-1 lg:col-span-6 p-4 border border-gray-300 h-fit">
        <h3 className="text-gray-800 dark:text-white font-medium text-xl mb-4">
          Shipping info
        </h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <label
            htmlFor="1"
            className={`flex p-4 w-full cursor-pointer border text-gray-600 dark:text-gray-300 rounded-md text-lg focus:border-blue-500 focus:ring-blue-500 transition-colors ${
              selectedRadio === "1"
          ...
          >
            ...
            <div className="flex flex-col">
              <span className=" text-gray-600 dark:text-gray-300 ml-3">Express delivery </span>
          ...
          <label
            htmlFor="2"
            className={`flex p-4 w-full border rounded-md text-lg text-gray-600 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500 transition-colors cursor-pointer   ${
              selectedRadio === "2"
                ? " border-blue-500 bg-blue-50 "
                : " hover:bg-gray-100 border-gray-300"
            }`}
          >
            ...
            />
            <div className="flex flex-col">
              <span className=" text-gray-600 dark:text-gray-300 ml-3">Post office</span>
              <span className=" text-xs text-gray-400 ml-3">
                20-30 days via post
              </span>
            </div>
          ...
          <label
            htmlFor="3"
            className={`flex p-4 w-full border cursor-pointer  rounded-md text-lg text-gray-600 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500 transition-colors  ${
              selectedRadio === "3"
                ? "border-blue-500 bg-blue-50 "
                : "hover:bg-gray-100 border-gray-300"
            }`}
          >
            ...
            />
            <div className="flex flex-col">
              <span className="text-gray-600 dark:text-gray-300 ml-3">Self pick-up</span>
              <span className="text-xs text-gray-400 ml-3">
                Come to our shop
              </span>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
          <div className="col-span-1 lg:col-span-2 gap-1 flex flex-col">
            <label className="text-gray-700 dark:text-gray-300 font-medium">Address</label>
            <input
              type="text"
              value={address}
              onChange={(e) => setAddress(e.target.value)}
              className={`bg-gray-50 hover:bg-white dark:bg-zinc-800 border border-gray-300 rounded p-1.5 focus:border-blue-600`}
          ...
          <div className="col-span-1 gap-1 flex flex-col relative">
            ...
            <select
              ...
              className="border border-gray-300 bg-gray-50 rounded p-2 hover:bg-white outline-none focus:outline-none focus:border-blue-600 dark:bg-zinc-800"
            >
          ...
          <div className="col-span-1 gap-1 flex flex-col">
            <label className="text-gray-700 dark:text-gray-300 font-medium">House</label>
            <input
              type="text"
              value={house}
          ...
          <div className="col-span-1 gap-1 flex flex-col">
            <label className="text-gray-700 dark:text-gray-300 font-medium">Postal code</label>
            <input
              type="number"
              value={postalCode}
          ...
          <div className="col-span-1 gap-1 flex flex-col">
            <label className="text-gray-700 dark:text-gray-300 font-medium">Zip</label>
            <input
              type="number"
              value={zip}
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-3 gap-1 flex flex-col">
            ...
            <textarea
              ...
              rows="5"
              className="bg-gray-50 hover:bg-white dark:bg-zinc-800 border border-gray-300 rounded p-1.5 outline-none focus:outline-none  resize-y focus:border-blue-600"
      ...
      <div className="col-span-1 sm:col-span-1 md:col-span-1 lg:col-span-3">
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="text-gray-600 dark:text-gray-300 font-medium">$213</span>
        </div>
        <div className="flex items-center justify-between mb-3">

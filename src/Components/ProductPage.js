...
import { faBasketShopping, faCheck, faStar } from '@fortawesome/free-solid-svg-icons';
...
function shuffleArray(array) {
  ...
  return (
  <>
  <div className='bg-white p-4 rounded-md grid grid-cols-12  gap-4 border border-gray-300 '>
    <div className='col-span-4 grid grid-cols-4  '>
        ...
        <div className='grid col-span-4 grid-cols-4 gap-2  '>
          <img src={product.img1} alt="" className='border border-gray-300 rounded-md p-2 cursor-pointer' />
          <img src={product.img2} alt="" className='border border-gray-300 rounded-md p-2 cursor-pointer' />
          <img src={product.img3} alt="" className='border border-gray-300 rounded-md p-2 cursor-pointer' />
          <img src={product.img4} alt="" className='border border-gray-300 rounded-md p-2 cursor-pointer' />
        </div>
    </div>
    <div className='col-span-5'>
      <span className="text-green-500 text-lg"><FontAwesomeIcon icon={faCheck} /> In stock</span>
      <div className='text-xl font-semibold text-slate-950 my-2'>{product.name}</div>
      <div className='flex gap-2 items-center'>
        <div>
          ...
          <span className='text-orange-400 ml-2'>{product.rating > 0 ? product.rating:'0'}</span>
        </div>
      ...
      <div className='bg-orange-100 shadow-sm w-full mt-4 flex items-center p-4 gap-8'>
        <div className="mr-10">
          <div className='text-red-600 text-xl mb-2 font-semibold'>${product.price}.00</div>
          <span className='text-gray-500'>50-100 pcs</span>
        </div>
        <div className="mr-10">
          <div className='text-slate-950 text-xl mb-2 font-semibold'>${(product.price / 100 * 90).toFixed(0)}.00</div>
          <span className='text-gray-500'>100-700 pcs</span>
        </div>
        <div className="">
          <div className='text-slate-950 text-xl mb-2 font-semibold'>${(product.price / 100 * 75).toFixed(0)}.00</div>
      ...
      <div className='mt-4'>
        <div className='border-b border-b-gray-300 py-4  flex'>
          ...
          <span className=' text-blue-600 text-lg font-semibold w-full text-center'>${product.price}</span>
        </div>
        <div className='border-b border-b-gray-300 py-4 '>
          <div className='py-2 flex'>
            <span className='text-gray-400'>category:</span>
            <span className=' text-gray-700 w-full text-center '>{product.category}</span>
          </div>
          <div className='py-2 flex'>
            <span className='text-gray-400'>Material: </span>
            <span className=' text-gray-700  w-full text-center '>unknown</span>
          </div>
          <div className='py-2 flex'>
            <span className='text-gray-400'>Design:</span>
            <span className=' text-gray-700 w-full text-center '>Modern</span>
          </div>
        </div>
        <div className=' py-4 '>
          <div className='py-2 flex'>
            <span className='text-gray-400'>Customization:</span>
            <span className=' text-gray-700  w-full text-center  text-sm'>Customized design</span>
          </div>
          <div className='py-2 flex'>
            <span className='text-gray-400'>Protection:</span>
            <span className=' text-gray-700  w-full text-center '>Refund Policy</span>
          </div>
          <div className='py-2 flex'>
            <span className='text-gray-400'>Warranty:</span>
            <span className=' text-gray-700  w-full text-center '>2 years full warranty </span>
          </div>
        </div>
      </div>
    </div>
    <div className='col-span-3'>
      <div className='py-5 bg-white rounded-lg px-3 mb-4 border shadow-sm border-gray-300 ' >
        <div className='flex items-center border-b border-b-gray-300 pb-4'>
          <div className='text-3xl text-green-600 bg-emerald-200 font-bold rounded p-2 px-4 mr-4'>R</div>
  ...
  <path d="M9.9915 1.66663C5.3915 1.66663 1.6665 5.39996 1.6665 9.99996C1.6665 14.6 5.3915 18.3333 9.9915 18.3333C14.5998 18.3333 18.3332 14.6 18.3332 9.99996C18.3332 5.39996 14.5998 1.66663 9.9915 1.66663ZM15.7665 6.66663H13.3082C13.0415 5.62496 12.6582 4.62496 12.1582 3.69996C13.6915 4.22496 14.9665 5.29163 15.7665 6.66663ZM9.99984 3.36663C10.6915 4.36663 11.2332 5.47496 11.5915 6.66663H8.40817C8.7665 5.47496 9.30817 4.36663 9.99984 3.36663ZM3.54984 11.6666C3.4165 11.1333 3.33317 10.575 3.33317 9.99996C3.33317 9.42496 3.4165 8.86663 3.54984 8.33329H6.3665C6.29984 8.88329 6.24984 9.43329 6.24984 9.99996C6.24984 10.5666 6.29984 11.1166 6.3665 11.6666H3.54984ZM4.23317 13.3333H6.6915C6.95817 14.375 7.3415 15.375 7.8415 16.3C6.30817 15.775 5.03317 14.7166 4.23317 13.3333ZM6.6915 6.66663H4.23317C5.03317 5.28329 6.30817 4.22496 7.8415 3.69996C7.3415 4.62496 6.95817 5.62496 6.6915 6.66663ZM9.99984 16.6333C9.30817 15.6333 8.7665 14.525 8.40817 13.3333H11.5915C11.2332 14.525 10.6915 15.6333 9.99984 16.6333ZM11.9498 11.6666H8.04984C7.97484 11.1166 7.9165 10.5666 7.9165 9.99996C7.9165 9.43329 7.97484 8.87496 8.04984 8.33329H11.9498C12.0248 8.87496 12.0832 9.43329 12.0832 9.99996C12.0832 10.5666 12.0248 11.1166 11.9498 11.6666ZM12.1582 16.3C12.6582 15.375 13.0415 14.375 13.3082 13.3333H15.7665C14.9665 14.7083 13.6915 15.775 12.1582 16.3ZM13.6332 11.6666C13.6998 11.1166 13.7498 10.5666 13.7498 9.99996C13.7498 9.43329 13.6998 8.88329 13.6332 8.33329H16.4498C16.5832 8.86663 16.6665 9.42496 16.6665 9.99996C16.6665 10.575 16.5832 11.1333 16.4498 11.6666H13.6332Z" fill="#8B96A5"/>
        ...
        <div
          className='bg-white py-1.5 rounded-md text-md cursor-pointer hover:text-blue-800 hover:shadow text-center font-medium text-blue-600 border border-gray-300 transition-all duration-300 '>
          Seller’s profile
        </div>
      </div>
          <div className="flex justify-center transition-all duration-300 text-blue-600 mt-8 cursor-pointer text-md font-medium items-center gap-1 border border-gray-300  py-1.5 rounded-md hover:text-blue-800 hover:shadow"
      ...
      {inCart?  
        <Link to='/MyCart' className='rounded-md  py-1.5 bg-white border border-gray-300  text-blue-600 hover:bg-blue-600 hover:text-white transition-all duration-300  text-md cursor-pointer text-center mt-4 flex items-center  justify-center hover:shadow font-medium  ' onClick={handleAddToCart}>
        Go to Cart
        </Link>
        :
        <div className='rounded-md  py-1.5 bg-blue-600 hover:text-blue-600 hover:bg-white transition-all 
        duration-300 text-white text-md button text-center mt-4 flex items-center cursor-pointer justify-center hover:shadow hover:border hover:border-gray-300 ' onClick={handleAddToCart}>
        Add to Cart
        </div>
      }
    </div>
  ...
  <div className='grid grid-cols-12 gap-4 mt-4'>
    <div className='col-span-9 bg-white p-4 rounded-md border border-gray-300 shadow-sm '>
      <div className='flex gap-8 text-center border-b border-b-gray-400 rounded-md rounded-s-none rounded-e-none'>
        <span className='text-blue-600 activeOrder pb-2 mb-2 w-fit px-4 cursor-pointer'>Description</span>
      ...
      <div className='m-4 mb-8 text-gray-600'>{product.description} With supporting text below as a natural lead-in to additional content. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
          </div>
    <div className='flex gap-10'>
        <div className='mx-4 flex gap-4 flex-col'> 
        <span className='text-gray-700 font-medium'>
          <span className='text-green-600'>✔</span> Modern style and design
        </span>
        <span className='text-gray-700 font-medium'>
    ...
    <div className='col-span-3 bg-white p-4 rounded-md border border-gray-300 shadow-sm h-fit'>
      <span className=' text-gray-800 text-lg font-semibold'>Related Products</span>
          {filteredProducts && shuffleArray(filteredProducts).slice(0, 4).map((RelatedProduct) => (
            <div className='grid grid-cols-3 gap-4 mt-4 ' key={RelatedProduct.id}>
              <div className='border border-gray-300 p-2 col-span-1 rounded flex items-center justify-center cursor-pointer'
                onClick={() => handelChosenProduct(RelatedProduct.id, RelatedProduct.name, RelatedProduct.category)}>
              <img src={RelatedProduct.img1} className='w-20 h-12 cursor-pointer ' alt='' />
              </div>
              <div className='flex flex-col gap-1 col-span-2'>
                <span className=' text-gray-800 text-sm font-medium hover:text-blue-600 cursor-pointer'
                  onClick={()=>handelChosenProduct(RelatedProduct.id,RelatedProduct.name,RelatedProduct.category)} >
                  {RelatedProduct.name}
                </span>
                <span className='text-gray-500 text-sm font-medium'>${RelatedProduct.price}.00</span>
              </div>
            </div>
          ))}
    </div>
  ...
  <div className=' bg-white py-4 px-8 rounded-md border border-gray-300 flex flex-col gap-4 mt-4'>
      <span className=' text-gray-800 text-lg font-semibold'>You may like:</span>
      <div className='grid grid-cols-6 gap-4 items-center ' >
        {products && shuffleArray(products).slice(0, 6).map((RelatedProduct) => (
          <div className='flex flex-col gap-4' key={RelatedProduct.id}>
            ...
            <img src={RelatedProduct.img1} className=' h-28 w-fit p-2 cursor-pointer' alt='' 
              onClick={()=>handelChosenProduct(RelatedProduct.id,RelatedProduct.name,RelatedProduct.category)}/>
            </div>
              <div className='flex flex-col gap-1 '>
                <span className=' text-gray-800 text-sm font-medium hover:text-blue-600 cursor-pointer'
